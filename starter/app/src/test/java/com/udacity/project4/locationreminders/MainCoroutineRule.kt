...
class MainCoroutineRule(
    override val testScheduler: TestCoroutineScheduler = TestCoroutineScheduler()
) : TestWatcher(), TestCoroutineScope by TestCoroutineScope(StandardTestDispatcher(testScheduler)) {
